...
LABELS = {
    ...
    "aliyuncn": "Alibaba Cloud（China）",
    "tencentcn": "Tencent Cloud（China）",
    "volcanoenginecn": "Volcano Engine（China）",
    "ucloudcn": "UCloud（China）",
    "baiducn": "Baidu AI Cloud（China）",
    "cloudflare": "Cloudflare",
    "halocloudcn": "Guangdong Xingwang Technology Co., Ltd",
    "bgpgdcn": "Dongguan Xingxiu Technology Co., Ltd",
    "heptaskycn": "Shenzhen Qiyue Star Technology Co",
